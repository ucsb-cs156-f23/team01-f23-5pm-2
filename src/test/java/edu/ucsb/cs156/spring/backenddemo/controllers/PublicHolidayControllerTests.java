...
import edu.ucsb.cs156.spring.backenddemo.services.PublicHolidayQueryServiceTests;
...
public class PublicHolidayControllerTests {
  ...
  public void test_getPublicHoliday() throws Exception {
    ...
    String url = String.format("/api/publicholidays/get?countryCoder=%s&year=%s",countryCode,year);
